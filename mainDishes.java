...
public class mainDishes extends AppCompatActivity {
    ...
    ArrayList<ArrayList<String>> _mains = new ArrayList<ArrayList<String>>();
    ...
    public void onSave(View view){
        _mains = new ArrayList<ArrayList<String>>();
        ...
        for (int j=0; j <_mains.size(); j++) {
            System.out.println("Order "+(j+1)+": ");
            for (int i = 0; i < 3; i++) {
                ArrayList<String> row = _mains.get(j);
                System.out.println(row.get(i));
            }
        }

        //loading drink activity
        Intent myIntent = new Intent(getBaseContext(), drink.class);
